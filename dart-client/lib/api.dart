...
part 'model/ok_response_for_add_to_list_response.dart';
part 'model/ok_response_for_create_list_response.dart';
part 'model/ok_response_for_empty.dart';
part 'model/ok_response_for_get_account_name_response.dart';
part 'model/ok_response_for_get_history_response.dart';
part 'model/ok_response_for_get_lists_response.dart';
part 'model/ok_response_for_get_shares_response.dart';
part 'model/ok_response_for_login_response.dart';
part 'model/ok_response_for_read_list_response.dart';
part 'model/ok_response_for_recovery_info_response.dart';
part 'model/ok_response_for_search_account_response.dart';
