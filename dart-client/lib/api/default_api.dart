...
class DefaultApi {
  ...
  /// * [String] search:
  ///   Substring Search
  Future<OkResponse?> historySearch(String list, { String? search, }) async {
  ...
  /// * [String] name (required):
  ///   Account name
  Future<OkResponse?> searchAccount(String name,) async {
  ...
  /// * [String] name (required):
  ///   Part of the list name
  Future<OkResponse?> searchList(String name,) async {
