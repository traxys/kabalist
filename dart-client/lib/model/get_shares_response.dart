...
class GetSharesResponse {
  ...
  // ignore: unnecessary_parenthesis
    (sharedWith == null ? 0 : sharedWith.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'shared_with'] = sharedWith;
    if (publicLink != null) {
      json[r'public_link'] = publicLink;
    }
    return json;
  }
  ...
  static List<GetSharesResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GetSharesResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GetSharesResponse>[];
  ...
  static Map<String, GetSharesResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GetSharesResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetSharesResponse-objects as value to a dart map
  static Map<String, List<GetSharesResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GetSharesResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GetSharesResponse.listFromJson(
            value,
