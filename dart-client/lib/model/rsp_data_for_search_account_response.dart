...
class RspDataForSearchAccountResponse {
  ...
  static List<RspDataForSearchAccountResponse> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(RspDataForSearchAccountResponse.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <RspDataForSearchAccountResponse>[];
  ...
  static Map<String, RspDataForSearchAccountResponse> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = RspDataForSearchAccountResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of RspDataForSearchAccountResponse-objects as value to a dart map
  static Map<String, List<RspDataForSearchAccountResponse>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<RspDataForSearchAccountResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = RspDataForSearchAccountResponse.listFromJson(
            value,
