...
class RspDataForAddToListResponseOneOf {
  ...
  static List<RspDataForAddToListResponseOneOf> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(RspDataForAddToListResponseOneOf.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <RspDataForAddToListResponseOneOf>[];
  ...
  static Map<String, RspDataForAddToListResponseOneOf> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = RspDataForAddToListResponseOneOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of RspDataForAddToListResponseOneOf-objects as value to a dart map
  static Map<String, List<RspDataForAddToListResponseOneOf>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<RspDataForAddToListResponseOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = RspDataForAddToListResponseOneOf.listFromJson(
            value,
